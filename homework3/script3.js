...
const dog2 = {
    nikname: 'Umka',
    hobby: ['dream', 'food'],
    friend: {dad: 'the best friend', grandma: 'cook food',},
};

const people2 = {
    name: 'Jhon',
    wife: { name: 'Mesha', age:40},
    kids: ['Mhat', 'May'],
};
...
const flower2 = {
    genus: 'Helianthus',
    color: ['yellow', 'white'],
    description: {sten: 'strong', flowering: 30},
};

const flat2 = {
    room: 3,
    style: ['loft', 'minimalizm'],
    location: { city: 'Kyiv', sreet: 'Forest',}
};

const book2 = {
    call: 'The dairy',
    published: [1950, 1995, 2005],
    author: { name: 'Anne Frank', birth: 1930},
};
