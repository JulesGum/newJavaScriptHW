...
let arr7 = [23, 'Spring', true, NaN, null, undefined, ['dad', 'son'], -5, '$', false];
...
let arr8 = ['Summer', 25, true, 'false', 'Teacher', false, 'Glasses', 'Water', 89, true];
...
let arr9 = ['Summer', 25, true, 'false', 'Teacher', false, 'Glasses', '75', 89, true];
...
let arr10 = ['Summer', 25, true, 'false', 'Teacher', false, 'Glasses', '75', 89, true];
